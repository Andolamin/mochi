  ...
  module.exports = kind(
      /** @lends mochi.ToggleButton.prototype */ {
          ...
          updateKnobPosition: function (inValue) {
              ...
              if (dom.canTransform()) {
                  dom.transform(inControl, {translateX: xPos});
              } else {
           ...
           */
          calcKnob: function () {
              this.onXPos = (this.getBounds().width - this.$.toggleKnob.getBounds().width) - (parseInt(dom.getComputedStyleValue(this.$.toggleKnob.hasNode(), 'margin-left')) * 2);
          },
